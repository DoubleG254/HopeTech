    ...
    <div className="mx-auto py-12 px-4 md:px-8">
      <div className="container mx-auto p-4 bg-gray-200 rounded-xl shadow-2xl">
        ...
        <div className=" flex flex-wrap justify-center">
          <div className="bg-gray-200 p-4 md:p-6 rounded-xl border-b-2 border-r-2 border-blue-500 flex flex-col justify-between h-40">
        ...
        <div className="mt-8 text-center mb-8">
          <button onClick={handleClick} className="col-span-full px-4 py-2 bg-orange-600 hover:text-white hover:bg-blue-800 text-white rounded hover:bg-blue-800">Learn More About Our Process</button>
        </div>
      </div>
    </div>
  );
