  ...
  return (
    <div className="mx-auto py-12 px-4 md:px-8">
      ...
      <div className="mt-8 flex justify-center">
        <button onClick={handleClick} className="px-4 py-2 bg-orange-600 hover:text-black hover:bg-blue-800 text-white rounded hover:bg-blue-800    hover:text-white">Explore Our Services</button>
      </div>
    </div>
  );
};
